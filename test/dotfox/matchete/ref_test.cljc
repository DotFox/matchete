...
(deftest ref-test
  (is (= [{:path [:a] :value 42}
          ...
          {:value {:a 42 :b {:c 42 :d {:e 42}} :f [42 {:g 42} [{:h {:i 42}} 42]]}}]
        ((m/matcher
           {:walk [:or
...
(deftest sample
  (let [data {:deps {'acme/spaceship {:mvn/version "1.0.0"}
        ...
        matcher (m/matcher {:walk [:or
                                   ...
                                   [:search [:mvar :path] [:ref :walk]]]}
                  [:ref :walk])]
    (is (= [{:path [:deps] :val '{acme/spaceship {:mvn/version "1.0.0"} org.clojure/clojure {:mvn/version "1.10.1"}}}
            ...
            {:path [:aliases :mars :extra-deps] :val '{comms/serial {:mvn/version "2.4.2"} mars/rover {:mvn/version "1.14.9"}}}
